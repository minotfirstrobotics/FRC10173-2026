...
class SS_CameraPose_Left(commands2.Subsystem):
    ...
    def __init__(self, swerve_drive: SS_SwerveDrive):
        ...
        SmartDashboard.putBoolean("Vision/Enable In Auto", True)
    ...
    def periodic(self):
        ...
        SmartDashboard.putNumber("Vision/Left/Target Count", target_count)
        SmartDashboard.putNumber("Vision/Left/Best Ambiguity", ambiguity)
        SmartDashboard.putNumber("Vision/Left/Pose Jump", pose_jump)
