...
class Follower:
    ...
    Motor direction either matches the leader's configured direction or opposes it
    based on the MotorAlignment.
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlFollower(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.leader_id, self.motor_alignment.value))

    
    def with_leader_id(self, new_leader_id: int) -> 'Follower':
        """
    ...
    def with_motor_alignment(self, new_motor_alignment: MotorAlignmentValue) -> 'Follower':
        """
