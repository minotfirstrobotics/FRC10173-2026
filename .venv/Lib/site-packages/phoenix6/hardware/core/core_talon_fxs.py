...
from phoenix6.configs.talon_fxs_configs import TalonFXSConfiguration, TalonFXSConfigurator
from phoenix6.signals.spn_enums import ForwardLimitValue, ReverseLimitValue, AppliedRotorPolarityValue, ControlModeValue, ExternalMotorTempStatusValue, RobotEnableValue, DeviceEnableValue, MotorOutputStatusValue, DifferentialControlModeValue, BridgeOutputValue, ConnectedMotorValue
...
class CoreTalonFXS(ParentDevice, CommonTalonWithExternalMotor):
    ...
    Configuration = TalonFXSConfiguration
    """
    ...
    def get_external_motor_temp_status(self, refresh: bool = True) -> StatusSignal[ExternalMotorTempStatusValue]:
        ...
        """
        return self._common_lookup(SpnValue.EXTERNAL_MOTOR_TEMP_STATUS.value, "external_motor_temp_status", None, ExternalMotorTempStatusValue, True, refresh)
    ...
    def get_external_motor_temp(self, refresh: bool = True) -> StatusSignal[celsius]:
        ...
        :rtype: StatusSignal[celsius]
        """
        return self._common_lookup(SpnValue.EXTERNAL_MOTOR_TEMP.value, "external_motor_temp", None, celsius, True, refresh)
    ...
    def get_five_v_rail_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        :rtype: StatusSignal[volt]
        """
        return self._common_lookup(SpnValue.TALON_FXS_5_V_RAIL_VOLTAGE.value, "five_v_rail_voltage", None, volt, True, refresh)
    ...
    def get_analog_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        :rtype: StatusSignal[volt]
        """
        return self._common_lookup(SpnValue.TALON_FXS_GADGETEER_G3.value, "analog_voltage", None, volt, True, refresh)
    ...
    def get_raw_quadrature_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        :rtype: StatusSignal[rotation]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_QUAD_RAW_QUADRATURE_POSITION.value, "raw_quadrature_position", None, rotation, True, refresh)
    ...
    def get_raw_quadrature_velocity(self, refresh: bool = True) -> StatusSignal[rotations_per_second]:
        ...
        :rtype: StatusSignal[rotations_per_second]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_QUAD_RAW_QUADRATURE_VELOCITY.value, "raw_quadrature_velocity", None, rotations_per_second, True, refresh)
    ...
    def get_raw_pulse_width_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        :rtype: StatusSignal[rotation]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_PWM_RAW_PWM_POSITION.value, "raw_pulse_width_position", None, rotation, True, refresh)
    ...
    def get_raw_pulse_width_velocity(self, refresh: bool = True) -> StatusSignal[rotations_per_second]:
        ...
        :rtype: StatusSignal[rotations_per_second]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_PWM_RAW_PWM_VELOCITY.value, "raw_pulse_width_velocity", None, rotations_per_second, True, refresh)
    ...
    def get_fault_bridge_short(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_BRIDGE_SHORT.value, "fault_bridge_short", None, bool, True, refresh)
    ...
    def get_sticky_fault_bridge_short(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_BRIDGE_SHORT.value, "sticky_fault_bridge_short", None, bool, True, refresh)
    ...
    def get_fault_hall_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_HALL_SENSOR_MISSING.value, "fault_hall_sensor_missing", None, bool, True, refresh)
    ...
    def get_sticky_fault_hall_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_HALL_SENSOR_MISSING.value, "sticky_fault_hall_sensor_missing", None, bool, True, refresh)
    ...
    def get_fault_drive_disabled_hall_sensor(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_DRIVE_DISABLED_HALL_SENSOR.value, "fault_drive_disabled_hall_sensor", None, bool, True, refresh)
    ...
    def get_sticky_fault_drive_disabled_hall_sensor(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_DRIVE_DISABLED_HALL_SENSOR.value, "sticky_fault_drive_disabled_hall_sensor", None, bool, True, refresh)
    ...
    def get_fault_motor_temp_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_MOTOR_TEMP_SENSOR_MISSING.value, "fault_motor_temp_sensor_missing", None, bool, True, refresh)
    ...
    def get_sticky_fault_motor_temp_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_MOTOR_TEMP_SENSOR_MISSING.value, "sticky_fault_motor_temp_sensor_missing", None, bool, True, refresh)
    ...
    def get_fault_motor_temp_sensor_too_hot(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_MOTOR_TEMP_SENSOR_TOO_HOT.value, "fault_motor_temp_sensor_too_hot", None, bool, True, refresh)
    ...
    def get_sticky_fault_motor_temp_sensor_too_hot(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_MOTOR_TEMP_SENSOR_TOO_HOT.value, "sticky_fault_motor_temp_sensor_too_hot", None, bool, True, refresh)
    ...
    def get_fault_motor_arrangement_not_selected(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_MOTOR_ARRANGEMENT_NOT_SELECTED.value, "fault_motor_arrangement_not_selected", None, bool, True, refresh)
    ...
    def get_sticky_fault_motor_arrangement_not_selected(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_MOTOR_ARRANGEMENT_NOT_SELECTED.value, "sticky_fault_motor_arrangement_not_selected", None, bool, True, refresh)
    ...
    def get_fault_5_v(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_5_V.value, "fault_5_v", None, bool, True, refresh)
    ...
    def get_sticky_fault_5_v(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_5_V.value, "sticky_fault_5_v", None, bool, True, refresh)
    ...
    def set_control(self, request: Follower) -> StatusCode:
        ...
        The follower will atomically change its output type when it receives
        the leader's latest output status signal (DutyCycle, MotorVoltage,
        TorqueCurrent). If Talon is in torque control, the torque is copied -
        ...
        voltage output control, the motor voltage is matched. Motor direction
        either matches the leader's configured direction or opposes it based
        on the MotorAlignment.
        
        The leader must ensure the status signal corresponding to its control
        output type (DutyCycle, MotorVoltage, TorqueCurrent) is enabled. The
    ...
    def set_control(self, request: StrictFollower) -> StatusCode:
        ...
        cycle output control, the duty cycle is matched. If Talon is in
        voltage output control, the motor voltage is matched. Motor direction
        is strictly determined by the configured invert and not the leader. If
        you want motor direction to match or oppose the leader, use Follower
        instead.
    ...
    def clear_sticky_fault_motor_arrangement_not_selected(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        return self.configurator.clear_sticky_fault_motor_arrangement_not_selected(timeout_seconds)
