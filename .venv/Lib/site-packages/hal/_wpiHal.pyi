...
class tInstances:
    ...
    kDashboard_QDash: typing.ClassVar[tInstances]  # value = <tInstances.kFramework_MagicBot: 8>
    ...
    kRobotDriveSwerve_EasySwerve: typing.ClassVar[tInstances]  # value = <tInstances.kRobotDriveSwerve_EasySwerve: 19>
...
class tResourceType:
    ...
    kResourceType_RevMAXSplineEncoder: typing.ClassVar[tResourceType]  # value = <tResourceType.kResourceType_RevMAXSplineEncoder: 136>
